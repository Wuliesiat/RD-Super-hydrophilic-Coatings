...
# 导入工具函数
sys.path.append('/home/ubuntu/50T/lzy/lzy_sas0_backup/lzy/multi_mcp_server')  # 根据实际路径调整
from sci_mcp import (
...
async def main():
    ...
    input_file = "/home/ubuntu/50T/fsy/json/generate_stf_data/response_step1.json"  # 替换为实际文件路径
    output_file = "response_step2.json"  # 可选，如果不指定则覆盖输入文件
